...
function SentEmails() {
    ...
    function starClick(email) {
        ...
        if (emailInfo[0].starred === true) {
            ...
            axios.put(`https://backend-gmail-cloneport.onrender.com/updateEmailInfo/${email._id}`, sentEmailDetails)
                .then((response) => {
    ...
    function deleteClick(viewEmail) {
        ...
        axios.put(`https://backend-gmail-cloneport.onrender.com/updateEmailInfo/${viewEmail._id}`, sentEmailDetails)
            .then((response) => {
